...
<body>
    <div class="min-h-[100vh] flex gap-1">
        ...
        <!-- content -->
        <div class="basis-[82%]  bg-grey p-4 flex justify-center" style="padding-left:10px;">
             <form class="z-10 bg-white rounded-md w-[40%] flex-col p-4" action="" method="post">
