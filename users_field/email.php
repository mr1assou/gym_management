<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($numRows==0) 
            ...
            header("location:./send_another_code.php?email=$email&status=change_password");
    }
?>
    ...
    <div class="w-full min-h-screen  bg-black px-[3%] pt-[2%]">
        <nav class="text-white flex justify-between items-center">
            ...
            <div class="flex items-center mb-2 z-10">
                ...
                <p class="text-green text-4xl text-center md:mt-2 mt-10">Your Email</p>
        <div class=" h-[100%] w-full  flex pt-3 px-2 items-center justify-center">
            ...
            <div class="flex justify-end mt-5">
                <input  type="submit" value="next" name="submit" class="text-white bg-green px-4 py-2 cursor-pointer rounded-md transform transition-transform duration-300 hover:scale-110">
            </div>
    </form>
</div>
</body>
